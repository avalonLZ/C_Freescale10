...
{ 
  ...
  PORT_PCR_REG(PORTB_BASE_PTR, 0) |= PORT_PCR_PE_MASK | PORT_PCR_PS_MASK ;      //开弱上拉
  PORT_PCR_REG(PORTB_BASE_PTR, 1) |= PORT_PCR_PE_MASK | PORT_PCR_PS_MASK ;      //开弱上拉
