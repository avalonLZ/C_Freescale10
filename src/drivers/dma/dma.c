...
void dma_init()         
	...
	DMA_TCD0_CITER_ELINKNO=DMA_CITER_ELINKNO_CITER(128);//当前主循环次数,采集点数
	DMA_TCD0_BITER_ELINKNO=DMA_BITER_ELINKNO_BITER(128);//起始主循环次数，采集点数
	...
	DMA_TCD0_DADDR=(uint32)Pixel;//设置目的地址，video数组第一个元素
